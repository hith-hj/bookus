      ...
      "
                    ...
                    <b-col cols="12" md="6">
                        <div class="d-flex align-items-center justify-content-end">
                            ...
                            <b-button
                                variant="primary"
                            >
                                <router-link :to="{ name: 'add-client'}" class="text-nowrap" tag="span">Add Client</router-link>
                            </b-button>
                        </div>
                    </b-col>
                </b-row>
        ...
        <div class="mt-3">
            ...
            <ul v-else class="mb-0 pl-3">
                <li v-for="name in submittedNames"></li>
            </ul>
        </div>
...
export default {
    ...
    data() {
        return {
            fields: ["first_name","last_name","email","status","action"],
            users: {},
            userSearch: null,
            perPage: 10,
            currentPage: 1,
    ...
    methods: {
        getUsers(page, perPage) {
            ...
            axios
                .get("/api/admin/users?page=" + page + "&limit=" + perPage, config)
                .then((res) => {
