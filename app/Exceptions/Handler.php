...
class Handler extends ExceptionHandler
{
    ...
    public function render($request, Throwable $e)
    {
        ...
        }else if(Str::startsWith($request->getRequestUri(),'/api/') && $e instanceof UnauthorizedException){
            return  response()->json([
                'result' => 'error',
                'content' => null,
        ...
        }else if(Str::startsWith($request->getRequestUri(),'/api/') && $e instanceof AuthenticationException){
            return  response()->json([
                'result' => 'error',
                'content' => null,
...
//        if (Str::startsWith($request->getRequestUri(),'/api/') && $this->isHttpException($e)) {
...
//                        'result' => 'error',
//                        'content' => null,
//                        'error_des' => 'internal server error',
//                        'error_validation' => null,
//                        'error_code' => 1,
//                        'date' =>date('Y-m-d')
//                    ],500);
